...
xst -ifn xst.scr
move PLL_9_6M_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PLL_9_6M_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PLL_9_6M_exdes.ucf PLL_9_6M_exdes

echo 'Running map'
map -timing -pr b PLL_9_6M_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm PLL_9_6M_exdes -w routed.ncd routed.v
cd ..
